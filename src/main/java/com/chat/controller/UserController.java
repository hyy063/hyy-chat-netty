...
public class UserController {
	...
	public ChatJSONResult uploadFaceBase64(@RequestBody UsersBO userBO) throws Exception {
		
		// 获取前端传过来的base64字符串, 然后转换为文件对象再上传
		String base64Data = userBO.getFaceData();
		String userFacePath = "/home/ubuntu/" + userBO.getUserId() + "userface64.png";
	...
	public ChatJSONResult getUnReadMsgList(String acceptUserId) {
		...
		// 查询列表
		List<com.chat.pojo.ChatMsg> unreadMsgList = userService.getUnReadMsgList(acceptUserId);
