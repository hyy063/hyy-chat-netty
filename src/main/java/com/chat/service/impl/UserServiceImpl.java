...
import com.chat.push.AsynCenter;
...
public class UserServiceImpl implements UserService {
	...
	public Users saveUser(Users user) {
		...
		// 为每个用户生成一个唯一的二维码
		String qrCodePath = "/home/ubuntu/" + userId + "qrcode.png";
		// muxin_qrcode:[username]
		qrCodeUtils.createQRCode(qrCodePath, "chat_qrcode:" + user.getUsername());
	...
	public void sendFriendRequest(String myUserId, String friendUsername) {
		...
		// 异步发送好友请求的推送通知
		asynCenter.sendPush("好友请求", "有一位新朋友请求添加您为好友", friend.getCid());
	}
	...
	public String saveMsg(ChatMsg chatMsg) {
		...
		com.chat.pojo.ChatMsg msgDB = new com.chat.pojo.ChatMsg();
	...
	@Transactional(propagation = Propagation.SUPPORTS)
	@Override
	public List<com.chat.pojo.ChatMsg> getUnReadMsgList(String acceptUserId) {
		
		Example chatExample = new Example(com.chat.pojo.ChatMsg.class);
		Criteria chatCriteria = chatExample.createCriteria();
		chatCriteria.andEqualTo("signFlag", 0);
		chatCriteria.andEqualTo("acceptUserId", acceptUserId);
		
		List<com.chat.pojo.ChatMsg> result = chatMsgMapper.selectByExample(chatExample);
